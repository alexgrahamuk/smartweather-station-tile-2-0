...
*/
metadata {
    definition (name: "SmartWeather Station Tile 2.1", namespace: "alexgrahamuk", author: "Takis") {
...
def poll() {
    ...
    if (obs) {
        ...
        send(name: "illuminance", value: "${obs.solarradiation.toFloat()*0.249}")
...
private get(feature) {
    getWeatherFeature(feature, "PWS:$stationId")
}
